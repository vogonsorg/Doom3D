...
*/
    ...
    *D_API.ptextureheight=textureheight = Z_Malloc (numtextures*4, PU_STATIC, 0);
...
void R_InitSpriteLumps (void)
{
    ...
    for (i=0 ; i< numspritelumps ; i++)
    {
		...
		spritewidth[i] = INT2F(SHORT(patch->width));
		spriteoffset[i] = INT2F(SHORT(patch->leftoffset));
		spritetopoffset[i] = INT2F(SHORT(patch->topoffset));
    }
}
