  ...
  fixed_t       y )
{
	...
	newsubsec = C_API.R_PointInSubsector (x,y);
	ceilingline = NULL;
...
void P_HitSlideLine (line_t* ld)
{
	...
	lineangle = C_API.R_PointToAngle2 (0,0, ld->dx, ld->dy);

	if (side == 1)
		lineangle += ANG180;

	moveangle = C_API.R_PointToAngle2 (0,0, tmxmove, tmymove);
